...
To setup Swift for use, navigate to the Swift website and locate your appropriate operating system. Install and follow the directions on how to perform further settings for use for your operatin system. If the language has been installed properly you will be able to type the following command in the terminal command line and receive the response shown:
```
$ swift --version
